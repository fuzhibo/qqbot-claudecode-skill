...
- **Channel 模式启动修复**: 修复 `loadEnvFromFile()` 调用时机错误导致 Channel 模式无法正常启动的问题
  - 将环境变量加载移至模块顶层，确保模式检测时环境变量已加载
  - 修复 `Channels are not currently available` 错误

## [1.20.0] - 2026-03-30

### 功能更新

  - 31dd4e3 feat: Doctor 配置自动升级 (v1.19.2)
  - 070e6f0 feat: 配置系统支持 .env 文件路径复用
  - d8df12b feat: 工作流程优化 - 一键启动体验 (v1.19.1)
  - b823590 feat: 原生 Channel 模式支持 (v1.19.0)
  - 8c5459b feat: 增强版本一致性检查和自动修复功能
  - 650fe4d fix: Headless 会话恢复修复 (v1.18.2)
  - cf4066e chore: release v1.18.1
  - b22dda5 feat: 稳定性增强 (v1.18.0)
  - 3f99621 feat: 授权超时与持久化功能 (v1.17.0)
  - 2c4c1b0 chore: release v1.16.2
